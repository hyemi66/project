...
<div id="aMain_cont">
	<div id="aBw_wrap">
		<h2 class="aBw_title">관리자 자료실 글쓰기</h2>
			<form method="post" action="admin_bbs_write_ok" onsubmit="return write_check();" enctype="multipart/form-data">
				<table id="aBw_t">
					<tr>
						<th>글쓴이</th>
						<td>
					...
					<tr>
						<th>글내용</th>
						<td>
							<textarea name="bbs_cont" id="bbs_cont" rows="9" cols="36"></textarea>
						</td>
					</tr>
					<tr>
						<th>파일첨부</th>
