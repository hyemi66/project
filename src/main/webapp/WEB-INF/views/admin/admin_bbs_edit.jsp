...
<div id="aMain_cont">
	...
	<h2 class="aBw_title">관리자 자료실 수정</h2>
		<form method="post" action="admin_bbs_edit_ok" onsubmit="return write_check();" enctype="multipart/form-data">
			...
			<table id="aBw_t">
				...
				<tr>
					<th>내용</th>
					<td>
						<textarea name="bbs_cont" id="bbs_cont" rows="9" cols="36">${b.bbs_cont}</textarea>
					</td>
				</tr>
				<tr>
					<th>파일첨부</th>
