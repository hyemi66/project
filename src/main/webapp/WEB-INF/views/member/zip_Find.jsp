...
function selectnow() {
	/* 
		...
		여기서 여러분들이 이해할것이 있다. 바로 form 객체가 두개 써였다는 것이다.
		그 이유는 동을입력하지 않았을때 실행과 동을 입력하고 검색된 동을 선택할수 있도록 하기 위해서
		postform과 postform2 두개의 폼객체 네임 이름을 사용하였다. 유의 하기 바란다. zip 변수에 선택된 주소가 저장된다. 
		
		zip1 변수에는 우편번호 앞 세자리를 저장하고 zip2 변수에는 우편번호 뒷자리 세자리를 저장한다.
		그리고 addr1변수에는 나머지 주소를 저장시켜준다.
		
		여기서 length-1 을 해준 이유는 substring 메서드는 문자열 첫 시작이 0부터 시작하고 length 속성은 첫 시작이 1부터 시작하기 때문이다.
		그리고 둘다 String 객체 하위의 구성요소라는 것을 꼭 알아주기 바란다.
	*/
...
<form method="post" action="zip_find_ok" name="postform" onsubmit="return check(this)">
	<table width="414" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td bgcolor="#999999" align="center">
				<input type="image" src="./images/member/ZipCode_img01.gif" width="413" height="58">
			</td>
		</tr>
		<tr>
		...
		<tr height="30">
			<td bgcolor="f5ffea" align="center">
				...
				<input type="image" src="./images/member/m-i02.gif" width="69" height="19" align="absmiddle" onfocus="this.blur()">
			</td>
		</tr>
		<%
			//if(dong != null){
